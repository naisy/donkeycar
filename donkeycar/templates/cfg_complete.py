...
TRAIN_LIMIT = None              #No limit. This effects keras 1epoch's training steps. If set, 20000, 40000, etc.
VALIDATION_LIMIT = 5000         #5000. This value must set for large datasets. If validation dataset has over 40k, keras will be memory leak.
