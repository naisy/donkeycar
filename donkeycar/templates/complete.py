...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            cam = CSICamera(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, framerate=cfg.CAMERA_FRAMERATE, gstreamer_flip=cfg.CSIC_CAM_GSTREAMER_FLIP_PARM, nvdewarper=cfg.NVDEWARPER, config_dewarper=cfg.CONFIG_DEWARPER)
    ...
    class DriveMode:
        ...
        def run(self, mode,
            ...
            if mode == 'user':
                ...
                return pilot_angle * cfg.STEERING_GAIN if pilot_angle else 0.0, \
                       pilot_throttle * cfg.THROTTLE_GAIN \
