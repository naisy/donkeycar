    ...
    class DriveMode:
        def run(self, mode,
            ...
            if mode == 'user':
                ...
                return pilot_angle * cfg.STEERING_GAIN if pilot_angle else 0.0, pilot_throttle * cfg.THROTTLE_GAIN if pilot_throttle else 0.0, pilot_brake if pilot_brake else 0.0
